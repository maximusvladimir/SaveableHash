...
public class TestWithClass {
	public static void main(String[] args) {
		...
		HashMap<String, MyBlandClass> myHash = new HashMap<String, MyBlandClass>();
		for (int i = 0; i < 10000; i++) {
			myHash.put("hash" + i, new MyBlandClass(genRandomString(),(int)(Math.random() * 2020020)));
		}
		...
		HashMap<String, MyBlandClass> myOtherHash = new HashMap<String, MyBlandClass>();
		try {
